document.addEventListener('DOMContentLoaded', () => {
    ...
    const productsData = [
        ...
        { category: 'accessories', subcategory: 'caps-headwear', name: 'Baseball Caps', imageA: 'images/products/baseball-caps-a.webp', imageB: 'images/products/1-caps-headwear-baseball-caps-2.webp', description: 'Custom baseball caps for brands and promotions.' },
